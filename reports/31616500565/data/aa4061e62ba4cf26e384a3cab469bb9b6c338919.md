    ...
    - list:
      ...
      - listitem:
        - link "Vacancies":
          - /url: "#"
      - button ""
- heading "Schedule Interview" [level=6]
- separator
- text: Candidate
- textbox: QACandidate 340451
- text: Vacancy
- textbox: QA Vacancy 333210
- text: Hiring Manager
- textbox: QA Admin
- text: Current Status
- textbox: Shortlisted
- text: Interview Title*
- textbox: First Round Interview
- text: Interviewer*
- textbox "Type for hints...": QA Admin
- button " Add Another"
- text: Date*
- textbox "yyyy-mm-dd": 2026-08-12
- text:  Time
- textbox "hh:mm"
- text:  Notes
- textbox "Type here"
